...
try {
    // Call API with client and get a response for call
    /**
     * From bootstrap.php
     * @var $client
     */
    ...
    //Item info
    $item_number = $item_number = $response->result->purchase_units[0]->items[0]->sku;
    ...
    if($result) {
        ...
        Logger::getLogger()->alert("PayPal: Error inserting into DB ");
    }
