...
/**
 * If the user is not logged in, return the user to the login page
 * @var Session $session
 */
if (!$session->isLoggedIn()) {
    header("Location: " . CONFIG_URL . "/login.php");
    die();
}
				...
				<td>
					<select name="cat">
						...
						// (C) Retrieve all categories from the database and return them as an array of category objects
                            $categories = Category::all(null, "name ASC");
